...
import { useNavigate } from "react-router-dom"; // If you're planning to use it later
...
const Addproduct = () => {
  ...
  const navigate = useNavigate(); // If you plan to use it
  ...
  useEffect(() => {
    if (isSuccess && createdProduct) {
      ...
      // Use navigate to redirect after success if needed
      navigate("/some-page"); // Example, replace with actual navigation
    }
    if (isError) {
